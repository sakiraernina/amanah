...
<head>
    <meta charset="utf-8" />
    <title>
        <?php echo $BRAND ?> Fakultas Universitas Gunung Rinjani
    </title>
    <meta name="description"
        content="<?php echo $BRAND ?> menjadi kampus yang memiliki alumni lulusan terbaik ditahun ini dengan terkenalnya fakultas hukum dan Agriculture ekonomi di Universitas Gunung Rinjani, masih ada banyak jurusan lainnya yang memiliki keunggulan yang bagus dengan bidangnya masing-masing serta memiliki akreditasi yang sama dengan kampus lain." />
    ...
    <meta name="og:url" content="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" />
    <meta name="og:title" content="<?php echo $BRAND ?> Kampus STIE Madani Balikpapan" />
    ...
    <meta name="og:image"
        content="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.VMYSz_z7.dyAU_YRkHGs_uumn1p.jpg" />
    <link rel="icon" type="image/x-icon" href="https://github.githubassets.com/favicons/favicon.png" />
    <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json" />
    <link rel="canonical" href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" />
    <link rel="amphtml" href="https://kitapastiyakin.shop/store/?id=<?php echo $BRAND ?>" />

    <!-- start preload -->
    <link rel="preload" href="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.VMYSz_z7.dyAU_YRkHGs_uumn1p.jpg"
        as="image" />
    ...
    <script type="text/javascript">
        ...
        var pdpTrackingData =
            '{"pdt_category":["Televisi & Video"],"pagetype":"pdp","pdt_discount":"","pdt_photo":"https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.VMYSz_z7.dyAU_YRkHGs_uumn1p.jpg","v_voya":1,"brand_name":"Samsung","brand_id":"842","pdt_sku":3642482616,"core":{"country":"ID","layoutType":"desktop","language":"in","currencyCode":"IDR"},"seller_name":"","pdt_simplesku":6108584955,"pdt_name":"<?php echo $BRAND ?> Kampus STIE Madani Balikpapan","page":{"regCategoryId":"300300002584","xParams":"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr="},"supplier_id":"","pdt_price":"Rp2.699.000"}';
        try {
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "Product",
        "name": "<?php echo $BRAND ?> Kampus STIE Madani Balikpapan",
        "image": "https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.VMYSz_z7.dyAU_YRkHGs_uumn1p.jpg",
        "description": "<?php echo $BRAND ?> menjadi kampus yang memiliki alumni lulusan terbaik ditahun ini dengan terkenalnya fakultas hukum dan Agriculture ekonomi di Universitas Gunung Rinjani, masih ada banyak jurusan lainnya yang memiliki keunggulan yang bagus dengan bidangnya masing-masing serta memiliki akreditasi yang sama dengan kampus lain.",
        "url": "https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>",
        "brand": {
          "@type": "Brand",
          "name": "<?php echo $BRAND ?>"
        },
        "offers": {
          ...
          "hasMerchantReturnPolicy": {
            ...
            "merchantReturnLink": "https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>",
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>"
                                            ...
                                            <div class="get-the-app-scope">
                                                <div class="get-the-app">
                                                    ...
                                                    <div class="app-stores">
                                                        <a href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" class="store-link">
                                                            <i class="app-apple"></i>
                                                        </a>
                                                        <a href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" class="store-link">
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="cyan" href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>"
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" data-spm="dhome"><img
                                        ...
                                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                                            ...
                                            <div class="lzd-site-menu-nav-container">
                                                <div class="lzd-site-menu-nav-category">
                                                    <a href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>">
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>" data-spm="dcart"><span class="cart-icon"></span>
                    ...
                    <div class="mui-zebra-module" id="J_icms-5000527-1511531232618"
                        ...
                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                            ...
                            <div class="lzd-site-menu-nav-container">
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item" href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>">
                            ...
                            <div class="gallery-preview-panel">
                                <div class="gallery-preview-panel__content">
                                    <img class="pdp-mod-common-image gallery-preview-panel__image"
                                        alt="<?php echo $BRAND ?> Kampus STIE Madani Balikpapan"
                                        src="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.VMYSz_z7.dyAU_YRkHGs_uumn1p.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="pdp-product-title">
                                    <div class="pdp-mod-product-badge-wrapper">
                                        <h1 class="pdp-mod-product-badge-title">
                                            <?php echo $BRAND ?> Kampus STIE Madani Balikpapan
                                        </h1>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://fp.ugr.ac.id/dosen/<?php echo $SMALLBRAND?>"><?php echo $BRAND ?></a>
