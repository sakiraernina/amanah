...
$canonical = "https://absensi.man2kotabjm.sch.id/storage/$dashbrand";
...
<head>
  ...
  <meta name="page google.co.id" content="https://www.google.co.id/search?q=<?php echo $dashbrand ?>">
...
<svg aria-hidden="true" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":" <?php echo $judul ?>","image":"//id-test-11.slatic.net/p/c08a6637647b6984097e3fcf63c97c3c.jpg","category":"Televisi & Video","brand":{"@type":"Brand","name":"Samsung","url":"<?php echo $canonical ?>"},"sku":"3642482616_ID-6108584955","mpn":3642482616,"description":"<?php echo $desc ?>","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","offers":{"@type":"Offer","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
...
<div class="error-message" id="topActionDownloadErrorMsg"></div>
        <div class="app-stores">
          <a href="<?php echo $canonical ?>" class="store-link">
            <i class="app-apple"></i>
          </a>
          <a href="<?php echo $canonical ?>" class="store-link">
  ...
  <div class="top-popup-content lzd-track-content">
    ...
    <div class="error-message" id="topActionTrackErrorMsg"></div>
                ...
                <div class="top-links-item  grey" id="anonLogin">
                  <a class="grey" href="<?php echo $cta ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5">LOGIN</a>
                </div>
                <div class="top-links-item  grey" id="anonSignup">
                  <a class="grey" href="<?php echo $cta ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6">DAFTAR</a>
                </div>
...
<div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
    <ul class="lzd-site-menu-root" data-spm="cate">
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            ...
            <a class="lzd-menu-labels-item" href="<?php echo $canonical ?>">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                    <img alt="Pulsa &amp;" class="lzd-site-nav-menu-iconfont-img" src="//laz-img-cdn.alicdn.com/images/ims-web/TB1Je4vhRr0gK0jSZFnXXbRRXXa.png">
                </span>
                <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
