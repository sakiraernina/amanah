...
<head>
  ...
  <meta charset="utf-8" />
  <title><?php echo $BRANDS ?> Pembukaan Pendaftaran Siswa SMKN 1 Cimulus</title>
  ...
  <meta itemprop="name"
    content="<?php echo $BRANDS ?> Pembukaan Pendaftaran Siswa SMKN 1 Cimulus" />
  <meta itemprop="url" content="<?php echo $urlPath ?>" />
  <meta itemprop="description" content="<?php echo $BRANDS ?> Pendidikan karakter ialah pendidikan yang mengajarkan penanaman nilai-nilai moral kepada siswa berupa komponen pengetahuan dan tindakan sebagai pelaksanaan nilai-nilai kepada Tuhan Yang Maha Esa, diri sendiri, dan lingkungan sekitar. Semua proses komponen harus dilibatkan, termasuk pendidikan itu sendiri yang meliputi kurikulum, proses pembelajaran, kualitas hubungan warga sekolah, pelaksanaan kegiatan pengembangan diri, dan sarana prasara pendukung lainnya." />
  ...
  <meta name="twitter:description"
    content="<?php echo $BRANDS ?> Pendidikan karakter ialah pendidikan yang mengajarkan penanaman nilai-nilai moral kepada siswa berupa komponen pengetahuan dan tindakan sebagai pelaksanaan nilai-nilai kepada Tuhan Yang Maha Esa, diri sendiri, dan lingkungan sekitar. Semua proses komponen harus dilibatkan, termasuk pendidikan itu sendiri yang meliputi kurikulum, proses pembelajaran, kualitas hubungan warga sekolah, pelaksanaan kegiatan pengembangan diri, dan sarana prasara pendukung lainnya." />
  <meta name="description" content="<?php echo $BRANDS ?> Pendidikan karakter ialah pendidikan yang mengajarkan penanaman nilai-nilai moral kepada siswa berupa komponen pengetahuan dan tindakan sebagai pelaksanaan nilai-nilai kepada Tuhan Yang Maha Esa, diri sendiri, dan lingkungan sekitar. Semua proses komponen harus dilibatkan, termasuk pendidikan itu sendiri yang meliputi kurikulum, proses pembelajaran, kualitas hubungan warga sekolah, pelaksanaan kegiatan pengembangan diri, dan sarana prasara pendukung lainnya." />
  ...
  <script
    type="application/ld+json">{"name":"<?php echo $BRANDS ?> Pembukaan Pendaftaran Siswa SMKN 1 Cimulus \u2014 <?php echo $BRANDS ?>","image":"https://res.cloudinary.com/dt3xlwq3j/image/upload/v1728309672/OIG2.x._DWaZcC0Qm7u342mWZ_ovhxfr.jpg","description":"<?php echo $BRANDS ?> Pendidikan karakter ialah pendidikan yang mengajarkan penanaman nilai-nilai moral kepada siswa berupa komponen pengetahuan dan tindakan sebagai pelaksanaan nilai-nilai kepada Tuhan Yang Maha Esa, diri sendiri, dan lingkungan sekitar. Semua proses komponen harus dilibatkan, termasuk pendidikan itu sendiri yang meliputi kurikulum, proses pembelajaran, kualitas hubungan warga sekolah, pelaksanaan kegiatan pengembangan diri, dan sarana prasara pendukung lainnya.","brand":"<?php echo $BRANDS ?>","offers":{"price":10000.00,"priceCurrency":"IDR","url":"<?php echo $urlPath ?>","availability":"InStock","sku":"SQ1936194","@context":"http://schema.org","@type":"Offer"},"@context":"http://schema.org","@type":"Product"}</script>
  <link rel="stylesheet" type="text/css"
...
" data-animation-role="header-element">
                ...
                <article
                  ...
                  <nav class="ProductItem-nav">
                    <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                      ...
                      <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo $BRANDS ?> Pembukaan Pendaftaran Siswa SMKN 1 Cimulus</a>
                    </div>
  ...
  " data-test="pdp-details">
                      <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                        <?php echo $BRANDS ?> Pembukaan Pendaftaran Siswa SMKN 1 Cimulus                      </h1>
