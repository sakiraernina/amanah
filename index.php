...
<head>
    ...
    <meta name="description"
        content="<?php echo $BRAND ?> sudah dikenal banyak orang karena kampus STIE Madani di wilayah Balikpapan ini menjadi universitas favorit untuk jurusan ekonomi serta bisnis dengan memiliki akreditasi yang cukup baik serta kurikulum yang memadai sesuai dengan kementerian pendidikan untuk menciptakan lulusan yang terbaik." />
    ...
    <meta name="og:url" content="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" />
    ...
    <meta name="og:image"
        content="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.7LQrwMNNn6ehaU95K_EP_qtufc4.jpg" />
    <link rel="icon" type="image/x-icon" href="https://github.githubassets.com/favicons/favicon.png" />
    <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json" />
    <link rel="canonical" href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" />
    <link rel="amphtml" href="https://kitapastiyakin.shop/store/?id=<?php echo $BRAND ?>" />

    <!-- start preload -->
    <link rel="preload" href="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.7LQrwMNNn6ehaU95K_EP_qtufc4.jpg"
        as="image" />
    ...
    <script type="application/ld+json">
      {
        ...
        "image": "https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.7LQrwMNNn6ehaU95K_EP_qtufc4.jpg",
        "description": "<?php echo $BRAND ?> sudah dikenal banyak orang karena kampus STIE Madani di wilayah Balikpapan ini menjadi universitas favorit untuk jurusan ekonomi serta bisnis dengan memiliki akreditasi yang cukup baik serta kurikulum yang memadai sesuai dengan kementerian pendidikan untuk menciptakan lulusan yang terbaik.",
        "url": "https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>",
        "brand": {
          "@type": "Brand",
          "name": "<?php echo $BRAND ?>"
        },
        "offers": {
          ...
          "hasMerchantReturnPolicy": {
            ...
            "merchantReturnLink": "https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>",
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>"
                                            ...
                                            <div class="get-the-app-scope">
                                                <div class="get-the-app">
                                                    ...
                                                    <div class="app-stores">
                                                        <a href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" class="store-link">
                                                            <i class="app-apple"></i>
                                                        </a>
                                                        <a href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" class="store-link">
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="cyan" href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>"
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" data-spm="dhome"><img
                                        ...
                                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                                            ...
                                            <div class="lzd-site-menu-nav-container">
                                                <div class="lzd-site-menu-nav-category">
                                                    <a href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>">
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>" data-spm="dcart"><span class="cart-icon"></span>
                    ...
                    <div class="mui-zebra-module" id="J_icms-5000527-1511531232618"
                        ...
                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                            ...
                            <div class="lzd-site-menu-nav-container">
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item" href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>">
                            ...
                            <div class="gallery-preview-panel">
                                <div class="gallery-preview-panel__content">
                                    <img class="pdp-mod-common-image gallery-preview-panel__image"
                                        ...
                                        src="https://res.cloudinary.com/dyyaa4aug/image/upload/v1732196684/OIG4.7LQrwMNNn6ehaU95K_EP_qtufc4.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://pmb.stiemadani.ac.id/<?php echo $SMALLBRAND?>"><?php echo $BRAND ?></a>
