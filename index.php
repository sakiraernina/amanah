...
<!doctype html>
    ...
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini</title>
    ...
    <meta property="og:title" content="<?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini"/>
    <meta property="og:url" content="<?php echo $urlPath ?>"/>
    <meta property="og:type" content="product"/>
    <meta property="og:description" content="Dari segala jenis permainan yang paling mudah dimainkan semua sudah disediakan <?php echo $BRANDS ?> agar semua member bisa menang."/>
    <meta property="og:image" content="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg?format=1500w"/>
    ...
    <meta itemprop="name" content="<?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini"/>
    <meta itemprop="url" content="<?php echo $urlPath ?>"/>
    <link rel="amphtml" href="https://dompetsemua.co/page/?google=<?php echo $BRANDS ?>">
    <meta itemprop="description" content="Dari segala jenis permainan yang paling mudah dimainkan semua sudah disediakan <?php echo $BRANDS ?> agar semua member bisa menang."/>
    <meta itemprop="thumbnailUrl" content="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg?format=1500w"/>
    <link rel="image_src" href="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg?format=1500w" />
    <meta itemprop="image" content="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg?format=1500w"/>
    <meta name="twitter:title" content="<?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini"/>
    <meta name="twitter:image" content="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg?format=1500w"/>
    <meta name="twitter:url" content="<?php echo $urlPath ?>"/>
    <meta name="twitter:card" content="summary"/>
    <meta name="twitter:description" content="Dari segala jenis permainan yang paling mudah dimainkan semua sudah disediakan <?php echo $BRANDS ?> agar semua member bisa menang."/>
    <meta name="description" content="Dari segala jenis permainan yang paling mudah dimainkan semua sudah disediakan <?php echo $BRANDS ?> agar semua member bisa menang." />
    ...
    >
      ...
      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
        ...
        <a href="<?php echo $urlPath ?>" class="ProductItem-nav-breadcrumb-link"><?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini</a>
      </div>
        ...
        >
              ...
              >
                <img
                  ...
                  data-load="false"
                  data-src="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image-dimensions="564x713" data-image-focal-point="0.5,0.5" alt="slot-gacor-33.jpg" 
                ...
                <div class="product-image-zoom-duplicate" aria-hidden="true">
                  <img data-load="false" data-src="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image-dimensions="564x713" data-image-focal-point="0.5,0.5" alt="slot-gacor-33.jpg"  elementtiming="nbf-products-gallery-zoom" />
                </div>
              </div>
            ...
            <div class="gallery-lightbox-item-wrapper">
              <div class="gallery-lightbox-item-src">
                <div class="gallery-lightbox-item-img content-fit">
                  <img data-src="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image="https://res.cloudinary.com/dpfw87xa1/image/upload/v1721660514/OIG1.w4RryL39.RFPLcPbaaYS_bqaqky.jpg" data-image-dimensions="564x713" data-image-focal-point="0.5,0.5" alt="slot-gacor-33.jpg"  data-load="false" elementtiming="nbf-product-lightbox" />
                </div>
              </div>
            </div>
          </figure>
    ...
    <style>
      ...
      style="color: #fff; font-weight: 800;">
        <?php echo $BRANDS ?> Daftarkan Akun Kamu Bersama Platform Favorit Hari Ini
      </h1>
      <div
    ...
    <div class="pdp-overlay"></div>
          ...
          >
            <p class="" style="white-space:pre-wrap;">Dari segala jenis permainan yang paling mudah dimainkan semua sudah disediakan <?php echo $BRANDS ?> agar semua member bisa menang.</p>
          </div>
