...
<head>
    <meta charset="utf-8" />
    <title>
        <?php echo $BRAND ?> PORTAL DPMPTSP KABUPATEN CIAMIS
    </title>
    <meta name="description"
        content="<?php echo $BRAND ?> memberikan portal atau platform yang biasa digunakan oleh setiap pegawai di kabupaten Ciamis agar bisa membantu untuk memudahkan setiap pekerjaan atau pelayanan kepada masyarakat menjadi lebih mudah serta efesien waktu bahkan bisa mengurangi setiap tindakan yang melanggar aturan lembaga." />
    ...
    <meta name="og:url" content="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" />
    <meta name="og:title" content="<?php echo $BRAND ?> PORTAL DPMPTSP KABUPATEN CIAMIS" />
    ...
    <link rel="canonical" href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" />
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "Product",
        "name": "<?php echo $BRAND ?> PORTAL DPMPTSP KABUPATEN CIAMIS",
        "image": "https://res.cloudinary.com/dp900fdbb/image/upload/v1734447187/OIG1.zatiB91an3aTSRwvIvdg_g1t0qg.jpg",
        "description": "<?php echo $BRAND ?> memberikan portal atau platform yang biasa digunakan oleh setiap pegawai di kabupaten Ciamis agar bisa membantu untuk memudahkan setiap pekerjaan atau pelayanan kepada masyarakat menjadi lebih mudah serta efesien waktu bahkan bisa mengurangi setiap tindakan yang melanggar aturan lembaga.",
        "url": "https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>",
        "brand": {
          "@type": "Brand",
          "name": "<?php echo $BRAND ?>"
        },
        "offers": {
          ...
          "hasMerchantReturnPolicy": {
            ...
            "merchantReturnLink": "https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>",
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>"
                                            ...
                                            <div class="get-the-app-scope">
                                                <div class="get-the-app">
                                                    ...
                                                    <div class="app-stores">
                                                        <a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" class="store-link">
                                                            <i class="app-apple"></i>
                                                        </a>
                                                        <a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" class="store-link">
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="cyan" href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>"
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" data-spm="dhome"><img
                                            src="https://i.ibb.co/xgYwg8m/slot-gacor-12-30-2023.webp"
                                            alt="logo <?php echo $BRAND ?>" /></a>
                                </div>
                                <div class="lzd-nav-search" data-spm="search">
                                    <marquee behavior="" direction="">
                                          <?php echo $BRAND ?> memberikan portal atau platform yang biasa digunakan oleh setiap pegawai di kabupaten Ciamis agar bisa membantu untuk memudahkan setiap pekerjaan atau pelayanan kepada masyarakat menjadi lebih mudah serta efesien waktu bahkan bisa mengurangi setiap tindakan yang melanggar aturan lembaga.
                                    </marquee>
                                        ...
                                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                                            ...
                                            <div class="lzd-site-menu-nav-container">
                                                <div class="lzd-site-menu-nav-category">
                                                    <a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>">
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>" data-spm="dcart"><span class="cart-icon"></span>
                    ...
                    <div class="mui-zebra-module" id="J_icms-5000527-1511531232618"
                        ...
                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                            ...
                            <div class="lzd-site-menu-nav-container">
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item" href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>">
                            ...
                            <div class="gallery-preview-panel">
                                <div class="gallery-preview-panel__content">
                                    <img class="pdp-mod-common-image gallery-preview-panel__image"
                                        alt="<?php echo $BRAND ?> PORTAL DPMPTSP KABUPATEN CIAMIS"
                ...
                <div id="block-n8THsmEaVS" class="pdp-block pdp-block__main-information-detail">
                    <div id="block-6QhDn4z1db" class="pdp-block">
                        <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>"><?php echo $BRAND ?></a>
                            ...
                            <div class="content">
                                <p><a href="https://dpmptsp.ciamiskab.go.id/temp/<?php echo $SMALLBRAND?>"><strong  style="color: rgb(255, 0, 0);"><?php echo $BRAND ?></strong></a> memberikan portal atau platform yang biasa digunakan oleh setiap pegawai di kabupaten Ciamis agar bisa membantu untuk memudahkan setiap pekerjaan atau pelayanan kepada masyarakat menjadi lebih mudah serta efesien waktu bahkan bisa mengurangi setiap tindakan yang melanggar aturan lembaga.</p>
